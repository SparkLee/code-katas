...
[@see](http://codingdojo.org/kata/Args/)
...
In Robert C. Martin’s book there is a full worked solution written in Java. He mentions in a footnote on page 200 that he has also solved it in Ruby. His Java code is available on [http://github.com/unclebob/javaargs](http://github.com/unclebob/javaargs), and the Ruby version is available on [http://github.com/unclebob/rubyargs](http://github.com/unclebob/rubyargs)